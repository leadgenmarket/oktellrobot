...
var ScenariosHandlers = /** @class */ (function () {
    function ScenariosHandlers(scenarios) {
        var _this = this;
        this.addScenario = function (req, res) { return __awaiter(_this, void 0, void 0, function () {
                ...
                switch (_a.label) {
                    case 0:
                        try {
                            ...
                            res.status(400);
                            logger_1.default.error("error parsing body addScenario handler");
                            res.json({ payload: "error parsing body", err: e });
                            return [2 /*return*/];
                        }
                        if (scenario.validate() !== "") {
                            msg = "addScenario: error in request check " + scenario.validate() + " param";
                            logger_1.default.error(msg);
                            res.status(400);
                            res.json({ payload: msg });
                            return [2 /*return*/];
                        }
                        return [4 /*yield*/, this.scenarios.add(scenario)];
                    case 1:
                        result = _a.sent();
                        if (result) {
...
exports.default = ScenariosHandlers;
