...
process.env.APP_TYPE = "outbound"; /* remove */
...
var services = new services_1.default(repositories, process.env.APP_TYPE == "outbound");
var handlers = new handlers_1.default(app, services);
handlers.initHandlers();
var server;
if (process.env.APP_TYPE == "outbound") {
    server = app.listen(PORT, function () { return console.log("Running on " + PORT + " \u26A1"); });
}
var callsInterval;
if (process.env.APP_TYPE == "outbound") {
    //с интервалом в минуту смотрим нужно ли совершать звонки
    callsInterval = setInterval(function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    console.log("make calls");
                    return [4 /*yield*/, services.tasks.makeCalls()];
                case 1:
                    _a.sent();
                    return [2 /*return*/];
            }
